import { ENCRYPTION_KEY, GAME_STATE_STORAGE_KEY, USADAS_STORAGE_KEY, RULE_TURN_PASS_KEY, RULE_IMG_COLOR_KEY, LAST_SELECTED_MODE_KEY, LAST_SELECTED_TIMER_KEY, RULE_TOGGLE_IMG_WORD_KEY  } from './config.js';
